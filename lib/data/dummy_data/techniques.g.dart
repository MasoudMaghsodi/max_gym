...
extension TechniqueQueryFilter
  ...
  QueryBuilder<Technique, Technique, QAfterFilterCondition> descriptionEqualTo(
    String value, {
  ...
  QueryBuilder<Technique, Technique, QAfterFilterCondition> descriptionLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Technique, Technique, QAfterFilterCondition> descriptionBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Technique, Technique, QAfterFilterCondition> descriptionEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Technique, Technique, QAfterFilterCondition> descriptionContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Technique, Technique, QAfterFilterCondition> descriptionMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TechniqueQuerySortBy on QueryBuilder<Technique, Technique, QSortBy> {
  QueryBuilder<Technique, Technique, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<Technique, Technique, QAfterSortBy> sortByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TechniqueQuerySortThenBy
  ...
  QueryBuilder<Technique, Technique, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<Technique, Technique, QAfterSortBy> thenByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.desc);
    });
  }
...
extension TechniqueQueryWhereDistinct
  ...
  QueryBuilder<Technique, Technique, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TechniqueQueryProperty
  ...
  QueryBuilder<Technique, String, QQueryOperations> descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
