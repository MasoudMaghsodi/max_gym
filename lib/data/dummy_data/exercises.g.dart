...
void _exerciseSerialize(
  ...
  writer.writeStringList(offsets[1], object.targetMuscles);
  writer.writeString(offsets[2], object.tool);
}
...
Exercise _exerciseDeserialize(
  ...
  final object = Exercise(
    ...
    targetMuscles: reader.readStringList(offsets[1]) ?? [],
    tool: reader.readString(offsets[2]),
  );
  object.id = id;
  return object;
}
